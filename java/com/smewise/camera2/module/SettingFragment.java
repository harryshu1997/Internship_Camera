...
public class SettingFragment extends PreferenceFragment {
    ...
    private boolean HDRPref;
    private long max_frame_duration;
...
//    private void setFrameDuration(String cameraID, String key){
//        EditTextPreference prePreference = (EditTextPreference) findPreference(key);
//        StreamConfigurationMap map = mManger.getConfigMap(cameraID);
//        prePreference.setTitle("帧频max:" +max_frame_duration);
//
//
//    }
    ...
    private void initPreference() {
        ...
        //set frame duration
        StreamConfigurationMap map = mManger.getConfigMap(cameraId);
        //max_frame_duration = mManger.getCharacteristics(cameraId).get(CameraCharacteristics.SENSOR_INFO_MAX_FRAME_DURATION);
        //setFrameDuration(cameraId, CameraSettings.KEY_FRAME_DURATION);
        //initialize exposure time
        //EditTextPreference prePreference = (EditTextPreference) findPreference(CameraSettings.KEY_EXPOSURE_TIME);
        //prePreference.setTitle("曝光时间(Recommand >= 1000000):");
        //initialize aperture show
        EditTextPreference preference2 = (EditTextPreference) findPreference(CameraSettings.KEY_LEN_APERTURE);

        float []apertures =  mManger.getCharacteristics(cameraId).get(CameraCharacteristics.LENS_INFO_AVAILABLE_APERTURES);
        String ap = "";
        for(float f : apertures){
            ap += f + " ";
        }
        preference2.setTitle("可选光圈 " + ap);
        //set pic format
...
//    public void AddData1(String name, long newEntry){
//        boolean insertData = db1.addData(name, newEntry);
//
//        if(insertData){
//            Log.i(TAG,"Data successfully Inserted CBD1");
//        }else{
//            Log.i(TAG,"Data Failed CDB1");
//        }
//    }
//
//    public void AddData2(String name, long newEntry){
//        boolean insertData = db2.addData(name, newEntry);
//
//        if(insertData){
//            Log.i(TAG,"Data successfully Inserted CBD2");
//        }else{
//            Log.i(TAG,"Data Failed CDB2");
//        }
//    }
    ...
    private SharedPreferences.OnSharedPreferenceChangeListener mPreferenceChangeListener = new
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            switch (key) {
//                case CameraSettings.KEY_FRAME_DURATION:{
//                    String duration = ((EditTextPreference) preference).getText();
//                    long val;
//                    try{
//                         val = Long.parseLong(duration);
//                    }catch (Exception e){
//                        e.printStackTrace();
//                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//                            Toast.makeText(getContext(),"Wrong Frame Duration input",Toast.LENGTH_SHORT).show();
//                        }
//                        return;
//                    }
//                    if(val < 0 || val > max_frame_duration){
//                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//                            Toast.makeText(getContext(),"Wrong Frame Duration input",Toast.LENGTH_SHORT).show();
//                        }
//                        return;
//                    }
//                    ProfessionalModule.setDuration(val);
//                    preference.setSummary(((EditTextPreference) preference).getText());
//                    //save db settings
//                    if(g.getC1()){
//                        AddData1("FrameDuration",val);
//                    }
//                    if(g.getC2()){
//                        AddData2("FrameDuration",val);
//                    }

                //break;
            //}
                case CameraSettings.KEY_HDR:{
                    HDRPref = ((CheckBoxPreference)preference).isChecked();
                    ProfessionalModule.setIsHDR(HDRPref);
                    Log.i(TAG,"set isHDR to " + HDRPref);
                    break;
                }
//                case CameraSettings.KEY_EXPOSURE_TIME:{
//                    String expTime = ((EditTextPreference) preference).getText();
//                    try{
//                        long exp = Long.parseLong(expTime);
//                        if(exp < 0){
//                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//                                Toast.makeText(getContext(),"can not less than 0",Toast.LENGTH_SHORT).show();
//                            }
//                            throw new Exception("can not less than 0");
//                        }
//                        ProfessionalModule.setExp(exp);
//                    }catch (Exception e){
//                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//                            Toast.makeText(getContext(),"invalid input",Toast.LENGTH_SHORT).show();
//                        }
//                        Log.i(TAG,"Wrong number for Exposure Time");
//                        return;
//                    }
//                    //save db settings
////                    if(g.getC1()){
////                        AddData1("ExpTime",Long.parseLong(expTime));
////                    }
////                    if(g.getC2()){
////                        AddData2("ExpTime",Long.parseLong(expTime));
////                    }
//
//                    Log.i(TAG,"get exposure time successful! " + expTime);
//                    preference.setSummary(((EditTextPreference) preference).getText());
//                    break;
//                }

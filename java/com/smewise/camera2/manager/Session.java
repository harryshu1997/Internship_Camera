...
public abstract class Session {
    ...
    public static final int RQ_SENSOR_SENSITIVITY = 13;
    public static final int RQ_AE_MODE = 14;
    public static final int RQ_SENSOR_EXPOSURE_TIME = 15;
    public static final int RQ_HDR = 16;
    public static final int RQ_FRAME_DURATION = 17;
    public static final int RQ_MODE = 18;
    public static final int RQ_ZOOM = 19;
    public static final int RQ_FOCUS_LENGTH = 20;
    ...
    public void applyRequest(int msg, Object value) {
        System.out.println("msg: " + msg + "  value: " + value);

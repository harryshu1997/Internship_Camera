...
public class RequestManager {
    ...
    public void setCharacteristics(CameraCharacteristics characteristics) {
        ...
        //add zoom 2021/6/9
        zoom = new Zoom(mCharacteristics);
    }
    ...
    public CaptureRequest getFocusLengthRequest(CaptureRequest.Builder builder, float length) {
        int afMode = getValidAFMode(CaptureRequest.CONTROL_AF_MODE_OFF);
        // preview
        builder.set(CaptureRequest.CONTROL_AF_MODE, afMode);
    ...
    public CaptureRequest getZoomRequest(CaptureRequest.Builder builder, float val){
        builder = zoom.setZoom(builder,val);
        Log.i(TAG,"set zoom to: " + val);
        return builder.build();
    }
